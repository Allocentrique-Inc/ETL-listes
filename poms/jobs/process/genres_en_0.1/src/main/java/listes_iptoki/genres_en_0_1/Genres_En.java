...
package listes_iptoki.genres_en_0_1;
...
/**
 * Job: Genres_En Purpose: Extraire les instrments de musique depuis Wikipedia<br>
 ...
 * @status DEV
 */
public class Genres_En implements TalendJob {
	...
	private final String jobName = "Genres_En";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Genres_En.this, new Object[] { e,
	...
	public void tExtractRegexFields_4_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tExtractRegexFields_5_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tExtractRegexFields_6_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public static class jsonStruct implements
		...
		final static byte[] commonByteArrayLock_LISTES_IPTOKI_Genres_En = new byte[0];
		static byte[] commonByteArray_LISTES_IPTOKI_Genres_En = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LISTES_IPTOKI_Genres_En.length) {
					if (length < 1024
							&& commonByteArray_LISTES_IPTOKI_Genres_En.length == 0) {
						commonByteArray_LISTES_IPTOKI_Genres_En = new byte[1024];
					} else {
						commonByteArray_LISTES_IPTOKI_Genres_En = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LISTES_IPTOKI_Genres_En, 0,
						length);
				strReturn = new String(commonByteArray_LISTES_IPTOKI_Genres_En,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LISTES_IPTOKI_Genres_En) {
	...
	public void tHttpRequest_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				java.io.PrintWriter outtFileOutputJSON_1 = new java.io.PrintWriter(
						new java.io.BufferedWriter(new java.io.FileWriter(
								"./listes/genres_en.json")));
				outtFileOutputJSON_1.append("{\"" + "genres" + "\":[");
				...
				/**
				 * [tExtractRegexFields_6 begin ] start
				 */

				ok_Hash.put("tExtractRegexFields_6", false);
				start_Hash.put("tExtractRegexFields_6",
						System.currentTimeMillis());

				currentComponent = "tExtractRegexFields_6";
				...
				int tos_count_tExtractRegexFields_6 = 0;

				java.util.regex.Pattern pattern_tExtractRegexFields_6 = java.util.regex.Pattern
						.compile("^((?![Ii]n [Mm]usic).)*$");

				/**
				 * [tExtractRegexFields_6 begin ] stop
				 */

				/**
				 * [tExtractRegexFields_5 begin ] start
				 */

				ok_Hash.put("tExtractRegexFields_5", false);
				start_Hash.put("tExtractRegexFields_5",
						System.currentTimeMillis());

				currentComponent = "tExtractRegexFields_5";
				...
				int tos_count_tExtractRegexFields_5 = 0;

				java.util.regex.Pattern pattern_tExtractRegexFields_5 = java.util.regex.Pattern
						.compile("^((?![Tt]imeline).)*$");

				/**
				 * [tExtractRegexFields_5 begin ] stop
				 */

				/**
				 * [tExtractRegexFields_4 begin ] start
				 */

				ok_Hash.put("tExtractRegexFields_4", false);
				start_Hash.put("tExtractRegexFields_4",
						System.currentTimeMillis());

				currentComponent = "tExtractRegexFields_4";
				...
				int tos_count_tExtractRegexFields_4 = 0;

				java.util.regex.Pattern pattern_tExtractRegexFields_4 = java.util.regex.Pattern
						.compile("^((?![Gg]enres).)*$");

				/**
				 * [tExtractRegexFields_4 begin ] stop
				 */
										...
										if (row3.lien != null) {// C_01
											...
											while (matcher_tExtractRegexFields_3
												...
												if (row4 != null) {
													...
													row5 = null;
													if (row4.nom != null) {// C_01
														java.util.regex.Matcher matcher_tExtractRegexFields_4 = pattern_tExtractRegexFields_4
																.matcher(row4.nom);

														int groupCount_tExtractRegexFields_4 = matcher_tExtractRegexFields_4
																.groupCount();
														while (matcher_tExtractRegexFields_4
																.find()) {
															currentComponent = "tExtractRegexFields_4";
															...
															try {
																...
																String temp_tExtractRegexFields_4 = null;
															} catch (java.lang.Exception ex_tExtractRegexFields_4) {
																throw (ex_tExtractRegexFields_4);
															}

															tos_count_tExtractRegexFields_4++;
															...
															if (row5 != null) {
																...
																row6 = null;
																if (row5.nom != null) {// C_01
																	java.util.regex.Matcher matcher_tExtractRegexFields_5 = pattern_tExtractRegexFields_5
																			.matcher(row5.nom);

																	int groupCount_tExtractRegexFields_5 = matcher_tExtractRegexFields_5
																			.groupCount();
																	while (matcher_tExtractRegexFields_5
																			.find()) {
																		currentComponent = "tExtractRegexFields_5";
																		...
																		try {
																			...
																			String temp_tExtractRegexFields_5 = null;
																		} catch (java.lang.Exception ex_tExtractRegexFields_5) {
																			throw (ex_tExtractRegexFields_5);
																		}

																		tos_count_tExtractRegexFields_5++;
																		...
																		if (row6 != null) {
																			...
																			row7 = null;
																			if (row6.nom != null) {// C_01
																				java.util.regex.Matcher matcher_tExtractRegexFields_6 = pattern_tExtractRegexFields_6
																						.matcher(row6.nom);

																				int groupCount_tExtractRegexFields_6 = matcher_tExtractRegexFields_6
																						.groupCount();
																				while (matcher_tExtractRegexFields_6
																						.find()) {
																					currentComponent = "tExtractRegexFields_6";
																					...
																					try {
																						...
																						String temp_tExtractRegexFields_6 = null;
																					} catch (java.lang.Exception ex_tExtractRegexFields_6) {
																						throw (ex_tExtractRegexFields_6);
																					}

																					tos_count_tExtractRegexFields_6++;
																					...
																					if (row7 != null) {
																						...
																						{ // start
																							...
																							json_tmp.lien = "http://en.wikipedia.org"
																									+ row4.lien;
																							json = json_tmp;
																							...
																							out1_tmp.lien = "http://en.wikipedia.org"
																									+ row4.lien;
																							out1 = out1_tmp;
																							// ###############################
				...
				/**
				 * [tExtractRegexFields_4 end ] start
				 */
				...
				ok_Hash.put("tExtractRegexFields_4", true);
				end_Hash.put("tExtractRegexFields_4",
						System.currentTimeMillis());

				/**
				 * [tExtractRegexFields_4 end ] stop
				 */

				/**
				 * [tExtractRegexFields_5 end ] start
				 */
				...
				ok_Hash.put("tExtractRegexFields_5", true);
				end_Hash.put("tExtractRegexFields_5",
						System.currentTimeMillis());

				/**
				 * [tExtractRegexFields_5 end ] stop
				 */

				/**
				 * [tExtractRegexFields_6 end ] start
				 */
				...
				ok_Hash.put("tExtractRegexFields_6", true);
				end_Hash.put("tExtractRegexFields_6",
						System.currentTimeMillis());

				/**
				 * [tExtractRegexFields_6 end ] stop
				 */
			...
			try {
				...
				/**
				 * [tExtractRegexFields_4 finally ] start
				 */

				currentComponent = "tExtractRegexFields_4";

				/**
				 * [tExtractRegexFields_4 finally ] stop
				 */

				/**
				 * [tExtractRegexFields_5 finally ] start
				 */

				currentComponent = "tExtractRegexFields_5";

				/**
				 * [tExtractRegexFields_5 finally ] stop
				 */

				/**
				 * [tExtractRegexFields_6 finally ] start
				 */

				currentComponent = "tExtractRegexFields_6";

				/**
				 * [tExtractRegexFields_6 finally ] stop
				 */
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String fichier = "./listes/genres_en.json";
	...
	public static void main(String[] args) {
		final Genres_En Genres_EnClass = new Genres_En();

		int exitCode = Genres_EnClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Genres_En.class.getClassLoader()
					.getResourceAsStream(
							"listes_iptoki/genres_en_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = Genres_En.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Genres_En");
		}
...
/************************************************************************************************
 * 94618 characters generated by Talend Open Studio for Data Integration on the
 * 27 juin 2019 16:06:23 EDT
 ************************************************************************************************/
