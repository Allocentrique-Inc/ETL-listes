...
package listes_iptoki.instruments_en_0_1;
...
/**
 * Job: Instruments_En Purpose: Extraire les instrments de musique depuis Wikipedia<br>
 ...
 * @status DEV
 */
public class Instruments_En implements TalendJob {
	...
	private final String jobName = "Instruments_En";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Instruments_En.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Instruments_En.this, new Object[] { e,
	...
	public static class jsonStruct implements
		...
		final static byte[] commonByteArrayLock_LISTES_IPTOKI_Instruments_En = new byte[0];
		static byte[] commonByteArray_LISTES_IPTOKI_Instruments_En = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LISTES_IPTOKI_Instruments_En.length) {
					if (length < 1024
							&& commonByteArray_LISTES_IPTOKI_Instruments_En.length == 0) {
						commonByteArray_LISTES_IPTOKI_Instruments_En = new byte[1024];
					} else {
						commonByteArray_LISTES_IPTOKI_Instruments_En = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LISTES_IPTOKI_Instruments_En, 0,
						length);
				strReturn = new String(
						commonByteArray_LISTES_IPTOKI_Instruments_En, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LISTES_IPTOKI_Instruments_En) {
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String fichier = "./listes/instruments_en.json";
	...
	public static void main(String[] args) {
		final Instruments_En Instruments_EnClass = new Instruments_En();

		int exitCode = Instruments_EnClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Instruments_En.class
					.getClassLoader().getResourceAsStream(
							"listes_iptoki/instruments_en_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = Instruments_En.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Instruments_En");
		}
...
/************************************************************************************************
 * 74160 characters generated by Talend Open Studio for Data Integration on the
 * 23 juin 2019 14:29:44 EDT
 ************************************************************************************************/
