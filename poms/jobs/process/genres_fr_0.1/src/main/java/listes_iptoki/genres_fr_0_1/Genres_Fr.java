...
package listes_iptoki.genres_fr_0_1;
...
/**
 * Job: Genres_Fr Purpose: Extraire les instrments de musique depuis Wikipedia<br>
 ...
 * @status DEV
 */
public class Genres_Fr implements TalendJob {
	...
	private final String jobName = "Genres_Fr";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Genres_Fr.this, new Object[] { e,
	...
	public static class jsonStruct implements
		...
		final static byte[] commonByteArrayLock_LISTES_IPTOKI_Genres_Fr = new byte[0];
		static byte[] commonByteArray_LISTES_IPTOKI_Genres_Fr = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LISTES_IPTOKI_Genres_Fr.length) {
					if (length < 1024
							&& commonByteArray_LISTES_IPTOKI_Genres_Fr.length == 0) {
						commonByteArray_LISTES_IPTOKI_Genres_Fr = new byte[1024];
					} else {
						commonByteArray_LISTES_IPTOKI_Genres_Fr = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LISTES_IPTOKI_Genres_Fr, 0,
						length);
				strReturn = new String(commonByteArray_LISTES_IPTOKI_Genres_Fr,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LISTES_IPTOKI_Genres_Fr) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				java.net.URL url_tHttpRequest_1 = new java.net.URL(
						"https://fr.wikipedia.org/wiki/Liste_de_genres_musicaux");
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String fichier = "./listes/genres_fr.json";
	...
	public static void main(String[] args) {
		final Genres_Fr Genres_FrClass = new Genres_Fr();

		int exitCode = Genres_FrClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Genres_Fr.class.getClassLoader()
					.getResourceAsStream(
							"listes_iptoki/genres_fr_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = Genres_Fr.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Genres_Fr");
		}
...
/************************************************************************************************
 * 87145 characters generated by Talend Open Studio for Data Integration on the
 * 27 juin 2019 15:56:21 EDT
 ************************************************************************************************/
